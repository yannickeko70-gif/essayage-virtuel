...
const Group = ({ title, children }) => (
  <div style={{ marginBottom: '1.5rem' }}>
    <p style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '1.5px', textTransform: 'uppercase', color: '#9CA3AF', margin: '0 0 8px 4px' }}>
      {title}
    </p>
    <div style={{ background: '#fff', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid rgba(0,0,0,0.05)' }}>
...
export default function Profile() {
  ...
  return (
    <div style={{ paddingTop: '72px', minHeight: '100vh', background: '#F0F2F5' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto', padding: '0 16px 80px' }}>
        ...
        {/* ── Alertes ── */}
        {success && (
          <div style={{ background: '#ECFDF5', border: '1px solid #6EE7B7', borderRadius: '12px', padding: '14px 18px', marginBottom: '16px', color: '#065F46', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ✅ {success}
          </div>
        )}
        {error && (
          <div style={{ background: '#FEF2F2', border: '1px solid #FCA5A5', borderRadius: '12px', padding: '14px 18px', marginBottom: '16px', color: '#B91C1C', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ⚠️ {error}
          </div>
        )}
